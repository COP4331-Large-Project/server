...
const groups = express_1.default.Router();
/**
 * @swagger
 * path:
 * /groups/{id}:
 ...
 */
groups.get('/:id', group_1.default.fetch(false));
/**
 * @swagger
 * path:
 * /groups/{id}/thumbnail/:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.get('/:id/thumbnail/', group_1.default.thumbnail(false));
/**
 * @swagger
 * path:
 * /groups/:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.post('/', group_1.default.register);
/**
 * @swagger
 * path:
 * /groups/{id}:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.delete('/:id', group_1.default.delete(false));
/**
 * @swagger
 * path:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.delete('/:id/removeUser', group_1.default.removeUser);
/**
 * @swagger
 * path:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.post('/:inviteCode/join/', group_1.default.join);
/**
 * @swagger
 * path:
 * /groups/{id}/invite:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.post('/:id/invite', group_1.default.inviteUsers(false));
/**
 * @swagger
 * path:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.put('/:id/uploadImage', upload.single('groupPicture'), group_1.default.upload);
/**
 * @swagger
 * path:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.post('/:id/deleteImages', group_1.default.deleteImages);
/**
 * @swagger
 * path:
 * /groups/{id}:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.put('/:id', group_1.default.update);
/**
 * @swagger
 * path:
 * /groups/{id}/images:
 ...
 *                $ref: '#/components/schemas/APIError'
 */
groups.get('/:id/images', group_1.default.getImages);
